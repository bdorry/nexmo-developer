...
If Nexmo does not get a response within these time frames it will retry the request twice. If this fails, Nexmo will make two further attempts to access your Fallback Answer URL, if it is configured.
